...
func TestShowLoginPageAuthenticated(t *testing.T) {
	...
	r.GET("/u/login", middlewares.EnsureNotLoggedIn(), ShowLoginPage)
...
func TestLoginAuthenticated(t *testing.T) {
	...
	// Define the route similar to its definition in the routes file
	r.POST("/u/login", middlewares.EnsureNotLoggedIn(), PerformLogin)
...
func TestShowRegistrationPageAuthenticated(t *testing.T) {
	...
	// Define the route similar to its definition in the routes file
	r.GET("/u/register", middlewares.EnsureNotLoggedIn(), ShowRegistrationPage)
...
func TestRegisterAuthenticated(t *testing.T) {
	...
	// Define the route similar to its definition in the routes file
	r.POST("/u/register", middlewares.EnsureNotLoggedIn(), Register)
